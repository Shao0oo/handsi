// ============================================================================
// Windows Action Adapter - Stub implementation (future work)
// ============================================================================

use super::ActionAdapter;

/// Windows adapter stub (not yet implemented)
...
impl ActionAdapter for WindowsAdapter {
    fn initialize(&mut self) -> Result<(), String> {
        ...
        eprintln!("[Rust] WindowsAdapter initialized (stub - no actions implemented)");
        Ok(())
    }

    fn mouse_move(&self, _x: f64, _y: f64) -> Result<(), String> {
        Err("Windows adapter not yet implemented".to_string())
    }
    ...
    fn cleanup(&mut self) {
        ...
        eprintln!("[Rust] WindowsAdapter cleaned up");
    }
}
